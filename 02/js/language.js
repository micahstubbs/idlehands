...
function createLanguageGrammar() {
	...
	var v0 = ["a", "e", "i", "o", "a", "e", "i", "o", "eu", "oi", "io", "ia", "u", "aa", "oo","a", "ow", "ew", "e", "i", "o", "a", "e", "i", "o", "u", "aa", "oo", "a", "e", "i", "o", "a", "e", "i", "o", "u", "oo", "y", "a", "u", "ee", "iu", "uo", "ai", "ei", "e", "ia", "e", "i", "o", "a", "e", "i", "o", "u", "oo", "a", "e", "i", "o", "a", "e", "i", "o", "u", "oo", "oi", "oui", "ee", "ey", "ay", "ai", "ai", "y", "a", "u", "ee", "iu", "uo", "ai", "ei", "e", "ia", "io", "eu", "ie", "ai", "ei", "e", "ia", "io", "eu", "ie", "i", "au", "o", "ui"];
	var diacritical = ["ä", "ö", "å", "á", "æ", "é", "ø", "í", "ó", "ú"];

	var cStart = ["fr", "str", "tr", "kl", "tw", "sl",  "sn", "bl", "schr", "shr", "chr", "sp", "gr", "fl", "squ", "cl", "gl"];
	var cEnd = ["rp", "j", "nd", "mph", "ss", "lp", "rk", "lks", "ng", "tt", "rb", "tch", "ght", "nt", "ld","rl", "nk", "lt", "rb", "wm", "nx", "x", "nth", "lk", "zz", "rg", "mb", "k", "ck", "rn", "rd", "lph", "ll"];
	var cMid = ["cc", "tt", "rr", "nn", "xh", "tz", "rw", "ñ", "ny"];
	var cAny = ["b", "n", "b", "n", "p", "mn", "m", "s", "l", "zh", "k", "r", "d","v", "qu", "tz", "n", "m", "s", "r", "d", "b", "n", "m", "s", "r", "d", "d", "m", "gn", "m", "h", "d", "st", "j", "h", "q", "w", "g", "z", "sch", "sh", "ch", "m", "r", "n", "l", "k", "p", "ph", "ng", "b", "th", "v"];
	...
	language.punctuation = [getRandom(punctuation), getRandom(punctuation), getRandom(punctuation)];
	language.midPunctuation = [getRandom(midPunctuation), getRandom(midPunctuation)];
	...
	function wordCons() {
		...
		if (Math.random() > .95) {
			return randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end") + randomVariable("vowel-mid") + randomVariable("cons-end")
		}
		if (Math.random() > .93) {
			return randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end")
		}
		if (Math.random() > .88) {
			return randomVariable("cons-start") + randomVariable("vowel-end") + randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end")
		}
		if (Math.random() > .85) {
			return randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end") + randomVariable("vowel-mid") + randomVariable("cons-end") + randomVariable("vowel-mid") + randomVariable("cons-end")
		}
		if (Math.random() > .85) {
			return randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end") + randomVariable("vowel-mid") + randomVariable("cons-end")
		}
		...
		if (Math.random() > .7) {
			return randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end") + randomVariable("cons-start") + randomVariable("vowel-mid") + randomVariable("cons-end")
		}

		if (Math.random() > .7) {
			return randomVariable("cons-start") + randomVariable("vowel-mid") + "'" + randomVariable("vowel-mid") + randomVariable("cons-end")
		}
	...
	language["phrase-d"] = makePhrases(["#word-" + getRandom(steps) + "#", "#word-" + getRandom(steps) + "#", "#word-" + getRandom(steps) + "#"], 2, 3);
	language["phrase-c"] = makePhrases(["#phrase-d#", "#phrase-d#", "#word-" + getRandom(steps) + "#"], 2, 3);
	language["phrase-b"] = makePhrases(["#phrase-c#", "#phrase-c#", "#phrase-d#", "#word-" + getRandom(steps) + "#"], 2, 3);
	language["phrase-a"] = makePhrases(["#phrase-b#", "#phrase-b##midPunctuation# #phrase-b#","#phrase-b##midPunctuation# #phrase-b#", "#phrase-d##midPunctuation# #phrase-d#", "#phrase-d#", "#word-" + getRandom(steps) + "#"], 1, 3);
	language.sentence = ["#phrase-a.capitalize##punctuation#"];
language.greeting = ["#phrase-a.capitalize##punctuation#", "#phrase-c.capitalize##punctuation#", "#phrase-b.capitalize##punctuation#"];
...
function createCountry() {
	...
	country.greeting = inQuotes(country.grammar.flatten("#phrase-b.capitalize##punctuation#"));
	country.motto = inQuotes(country.grammar.flatten("#phrase-a.capitalize##punctuation#"));
